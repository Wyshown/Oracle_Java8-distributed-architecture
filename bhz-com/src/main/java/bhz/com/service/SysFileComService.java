...
//        file2.setType(type);
//        file2.setExt(extName);
//        file2.setBytes(bytes);
//        file2.setDataPath(FASTDFS_BASEURL + fileId);
//        file2.setDataGroup(dataGroup);
//        file2.setExpired(expired);
//        file2.setDescInfo(descInfo);
        file2.setUpdateBy(userId);
        sysFileComDao.insert(file2);
